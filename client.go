...
type Client interface {
	...
	LRSRAdd(lr string, ip_prefix string, nexthop string, output_port *string, policy *string, options map[string]string, external_ids map[string]string) (*OvnCommand, error)
...
func (c *ovndb) LRSRAdd(lr string, ip_prefix string, nexthop string, output_port *string, policy *string, options map[string]string, external_ids map[string]string) (*OvnCommand, error) {
	return c.lrsrAddImp(lr, ip_prefix, nexthop, output_port, policy, options, external_ids)
}
